...
const routes: Routes = [
  ...
  { path: 'about', component: AboutPageComponent, canActivate: [AuthGuard], data: { role: 'Admin' } },
  { path: 'contact', component: ContactPageComponent, canActivate: [AuthGuard], data: { role: 'Admin' } },
